...
fun MediaMetadataCompat.toMediaSource(dataSourceFactory: DataSource.Factory): MediaSource {
    val mediaItem = MediaItem.fromUri(this.mediaUri)
...
fun List<MediaMetadataCompat>.toMediaSource(
    ...
    forEach { metadataCompat ->
        concatenatingMediaSource.addMediaSource(metadataCompat.toMediaSource(dataSourceFactory))
    }
